...
import GUI.AccessControl.LibrarianGUI;
...
public class Login extends JFrame {
    ...
    public Login() {
        ...
        setResizable(false);
        setLayout(null);
        ImageIcon backgroundIcon = new ImageIcon(getClass().getResource("/GUI/photos/book.jpg"));
        ...
        loginButton.addActionListener(e -> {
            ...
            if (input.contains("@")) {
                memberId = Member.validateUser(input, pass);
            } else {
                memberId = Member.validateIDUser(input, pass);
            }
            if (memberId != null) {
                JOptionPane.showMessageDialog(this, "Welcome Member!");
                dispose();
                new MemberGUI(memberId);
            } else if (input.equals("ADMIN3060") && pass.equals("U@Admin36798")) {
